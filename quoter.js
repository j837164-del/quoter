...
const locationMaster = {
  // WEST OF BANFF
  "lake louise":               { region: "WEST", spur distance: 0 },
  "lake louise ski hill":      { region: "WEST", spur distance: 0 },
  "moraine lake":              { region: "WEST", spur distance: 0 },
  "field":                     { region: "WEST", spur distance: 0 },
  "emerald lake":              { region: "WEST", spur distance: 0 },
  "golden":                    { region: "WEST", spur distance: 0 },
  "jasper":                    { region: "WEST", spur distance: 0 },
  "columbia icefield":         { region: "WEST", spur distance: 0 },
  "bow lake numti jah lodge":  { region: "WEST", spur distance: 0 },
  "baker creek":               { region: "WEST", spur distance: 0 },
  "castle junction":           { region: "WEST", spur distance: 0 },
  "johnston canyon":           { region: "WEST", spur distance: 0 },
  "cory pass":                 { region: "WEST", spur distance: 0 },
  "fireside trailhead":        { region: "WEST", spur distance: 0 },
  "bourgeau lake trailhead":   { region: "WEST", spur distance: 0 },
  "healy creek":               { region: "WEST", spur distance: 0 },
  "red earth creek":           { region: "WEST", spur distance: 0 },
  "sunshine":                  { region: "WEST", spur distance: 0 },
  "sunshine village":          { region: "WEST", spur distance: 0 },
  "storm mountain lodge":      { region: "WEST", spur distance: 0 },
  "lake ohara":                { region: "WEST", spur distance: 0 },
  "radium hot springs":        { region: "WEST", spur distance: 0 },
  "kicking horse resort":      { region: "WEST", spur distance: 0 },
  "panorama ski area":         { region: "WEST", spur distance: 0 },
  "saskatchewan river crossing":{ region: "WEST", spur distance: 0 },

  // EAST OF BANFF (Spur distances applied only to off-highway points)
  "canmore":                   { region: "EAST", spur distance: 0 },
  "harvie heights":            { region: "EAST", spur distance: 0 },
  "deadmans flats":            { region: "EAST", spur distance: 0 },
  "exshaw":                    { region: "EAST", spur distance: 15 },
  "lac des arcs":              { region: "EAST", spur distance: 0 },
  "seebe":                     { region: "EAST", spur distance: 5 },
  "cochrane":                  { region: "EAST", spur distance: 0 },
  "calgary":                   { region: "EAST", spur distance: 0 },
  "calgary city":              { region: "EAST", spur distance: 0 },
  "yyc":                       { region: "EAST", spur distance: 0 },
  "edmonton":                  { region: "EAST", spur distance: 0 },
  "bragg creek":               { region: "EAST", spur distance: 20 },
  "kananaskis":                { region: "EAST", spur distance: 28 },
  "kananaskis village":        { region: "EAST", spur distance: 28 },
  "kananaskis golf course":    { region: "EAST", spur distance: 25 },
  "nakiska":                   { region: "EAST", spur distance: 22 },
  "engadine lodge":            { region: "EAST", spur distance: 35 },
  "goat creek":                { region: "EAST", spur distance: 10 },
  "mount shark helipad":       { region: "EAST", spur distance: 40 },
  "jamieson road":             { region: "EAST", spur distance: 10 },
  "rafter six ranch":          { region: "EAST", spur distance: 5 },
  "mini thni nakoda lodge":    { region: "EAST", spur distance: 5 },
  "nakoda casino":             { region: "EAST", spur distance: 0 },

  // HUB
  "banff":                     { region: "HUB",  spur distance: 0 },
  "mount norquay":             { region: "HUB",  spur distance: 0 },
  "norquay":                   { region: "HUB",  spur distance: 0 },
  "bankhead":                  { region: "HUB",  spur distance: 0 },
  "johnson lake":              { region: "HUB",  spur distance: 0 },
  "lake minnewanka":           { region: "HUB",  spur distance: 0 },
  "two jack lake":             { region: "HUB",  spur distance: 0 }
};
